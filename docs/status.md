...
规模：**53,332 行 Rust / 20 个 crate / 410 个测试函数 / 409 个用例通过（0 ignored） / clippy 0 警告**
...
| 层 | 证据 | 位置 |
|---|---|---|
| 单元 / 集成 | **409 passed / 0 failed / 0 ignored**；410 个测试函数；`clippy --workspace --all-targets` 0 警告（本仓） | `cargo test --workspace` |
