...
规模：**51,964 行 Rust / 20 个 crate / 395 个测试函数 / 394 个用例通过（0 ignored） / clippy 0 警告**
...
| 层 | 证据 | 位置 |
|---|---|---|
| 单元 / 集成 | **394 passed / 0 failed / 0 ignored**；395 个测试函数；`clippy --workspace --all-targets` 0 警告（本仓） | `cargo test --workspace` |
